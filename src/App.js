...
function App() {
  ...
  return (
    <div>
      <Navbar/>
      <Elements heading={"welcome"} text={text} properties={'elements-text-container'}/>
      <Elements heading={"welcome to see you again"} text={text2} properties={'elements-text-container2'}/>
    </div>
  );
}
